                ...
                <section className="w-5/6 m-2 bg-white flex justify-center">
                    <div className="row w-100">
                        <div className="col mb-3 col-12 text-center">
                            ...
                            {/*                       onError={error => {console.log(error); setE(error);} } noValidate={true}*/}
                            {/*        >*/}
                            ...
                            {/*            <TextValidator*/}
                            {/*                label="Avatar"*/}
                            {/*                onChange={onChangeEmployeeImagePath}*/}
                            {/*                name="image_path"*/}
                            {/*                multiple type="file" accept="image/*"*/}
                            {/*                validators={['isExist']}*/}
                            {/*                errorMessages={['Image is empty']}*/}
                            {/*            />*/}
                            ...
                            {/*            <SelectValidator defaultValue={'DEFAULT'} name="gender" onChange={e => setGender(e.target.value)}>*/}
                            ...
                            {/*                type="text"*/}
                            {/*                validators={['isExist']}*/}
                            {/*                errorMessages={['Address is empty']}*/}
                            {/*            />*/}
                            {/*            <Error error={errors['address'] ? errors['address'] : null}/>*/}
                            {/*            <SelectValidator defaultValue={'DEFAULT'} name="level" onChange={e => setLevel(e.target.value)}>*/}
                            ...
                            {/*            <TextValidator*/}
                            {/*                label="yearOfEx"*/}
                            {/*                onChange={e => {setYearOfEx(e.target.value);}}*/}
                            {/*                name="yearOfEx"*/}
                            {/*                value={yearOfEx}*/}
                            {/*                type="number"*/}
                            {/*                validators={['isExist','minNumber:0']}*/}
                            {/*                errorMessages={['The field is required','Address > 0']}*/}
                            {/*                min="0"*/}
                            {/*                required*/}
                            {/*            />*/}
                            {/*            <Error error={errors['yearOfEx'] ? errors['yearOfEx'] : null}/>*/}

                            {/*            <SelectValidator  defaultValue={'DEFAULT'} name="position" onChange={e => setPosition(e.target.value)}>*/}
